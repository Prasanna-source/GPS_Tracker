...
int SOS = D3;
int SLEEP_PIN  = D2; // Make this pin HIGH to make A9G board to go to sleep mode

String SOS_NUM = "+919284718313"; // Add a number on which you want to receive call or SMS
...
void setup()
{
  ...
  Serial1.begin(115200, SERIAL_8N1, 17, 16); // For A9G Board
